...
최신 1.2.0 버전이 배포된 지금은 fastkit의 핵심적인 UX는 다음 링크에서 확인 가능하다 : <https://bnbong.github.io/FastAPI-fastkit/#usage>
...
후속 버전 개발 마일스톤은 다음 링크에 정리해두었다 : <https://github.com/bnbong/FastAPI-fastkit/discussions/8>
